...
@section('content')
    <section class="breadcrumb-section mb-5 header-margin">
        <div class="container">
    ...
    <section class="about-section mb-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="{{ asset('public/web-assets/img/services1.png ') }}" alt="img" class="img-fluid"
                        srcset="">
                </div>
            </div>
        </div>
    ...
    <section class="why-choce-section mb-5 bg-b">
        <div class="container pb-5">
            <div class="row">
                <h1 class="text-center mb-5 mt-5"><span class="color-a">WHY CHOOSE
                        US</span></h1>
        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-md-5" data-aos="fade-left">
                    <img src="{{ asset('public/web-assets/img/Asset 2.png') }}" alt="img" class="ch-img"
                        srcset="">
                </div>
            </div>
        </div>
