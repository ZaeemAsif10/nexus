        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Create Project Detail</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{url('admin')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Create Project Detail</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Create Project Detail</h4>
                        </div>
                        <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            $('#projectForm').on('click', '.add_more', function() {
                ...
                html1 += '<tr class="secondRow">' +
                    ...
                    '<label>Title</label>' +
                    '<input type="text" name="title[]" class="form-control" placeholder="Enter Feature" required>' +
                    '</div>' +
                    '</td>' +
                    '<td class="border-0">' +
                    '<div class="form-group" id="fc">' +
                    '<label>Image</label>' +
                    '<input type="file" name="slide_image[]" class="form-control" placeholder="Enter Icon" required>' +
                    '</div>' +
                    '</td>' +
                    '<td class="border-0">' +
