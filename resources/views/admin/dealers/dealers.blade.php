            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="{{ url('dealers/create') }}" class="btn add-btn" title="Add Dealers"><i
                ...
                <div class="col-sm-12">
                    <div class="card mb-0">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Dealers</h4>
                        </div>
                        <div class="card-body">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            html += '<tr>' +
                                '<td>' + c + '</td>' +
                                '<td>' + data[i].firm_name + '</td>' +
                                '<td>' + data[i].phone + '</td>' +
                                '<td>' + data[i].email + '</td>' +
                                '<td><img src="{{ asset('storage/app/public/uploads/dealers') }}/' +
            ...
            $('#dealersTable').on('click', '.edit_dealers', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('input[name=firm_name]').val(data.dealer.firm_name);
